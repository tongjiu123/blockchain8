...
\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[width=1.75in]{figures/fig1a_issuance_latency.png}
\label{fig:exp1a}}
\hfil
\subfloat[]{\includegraphics[width=1.75in]{figures/fig1b_gas_cost.png}
\label{fig:exp1b}}
...
\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[width=1.75in]{figures/fig5a_revocation_gas_cost.png}
\label{fig:exp5a}}
\hfil
\subfloat[]{\includegraphics[width=1.75in]{figures/fig5b_revocation_verify_time.png}
\label{fig:exp5b}}
